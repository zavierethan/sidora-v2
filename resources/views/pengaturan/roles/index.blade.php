        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{route('transaksi.pengaturan.role.save')}}" method="POST" class="intro-y box">
                        @csrf
                        ...
                        <div id="horizontal-form" class="p-5">
                            <div class="preview">
                                <div class="form-inline">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Nama Role</label>
...
$(document).ready(function () {
    const table = $("#table").DataTable({
        ...
        ajax: {
            url: `/transaksi/pengaturan/roles/get-lists`, // Replace with your route
            type: 'GET',
            data: function (d) {
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/transaksi/pengaturan/roles/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Edit</a>
                        <div>
                    `;
                }
            }
