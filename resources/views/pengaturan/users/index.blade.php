        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{route('transaksi.pengaturan.user.save')}}" method="POST" class="intro-y box">
                        @csrf
                        ...
                        <div id="horizontal-form" class="p-5">
                            <div class="preview">
                                <!-- <div class="form-inline">
                                    <label for="input-wizard-2" class="form-label sm:w-40">Username</label>
                                ...
                                <div class="form-inline mt-5">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Email</label>
                                    <input type="email" class="form-control" name="email" id="email">
                                </div>
                                <div class="form-inline mt-5">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">No. Telepon</label>
                                    <input type="text" class="form-control" name="telepon" id="telepon">
                                </div>
                                <div class="form-inline mt-5">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Role</label>
                                    <select data-placeholder="Pilih Role" class="tom-select w-full form-control" id="role-id" name="role_id" required>
                                        <option value=" "> - </option>
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/transaksi/pengaturan/users/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Edit</a>
                        <div>
                    `;
                }
            }
