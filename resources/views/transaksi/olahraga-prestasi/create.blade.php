            ...
            <div class="grid grid-cols-12 gap-2 gap-y-5 mt-5">
                ...
                <div class="intro-y col-span-12 sm:col-span-6 p-5">
                    ...
                    <div class="form-inline mt-5">
                        ...
                        <input type="text" class="form-control" name="cabang_olahraga" id="cabang-olahraga">
                    </div>
                    <div class="form-inline mt-5">
...
$(function() {
    ...
    $('#confirm-and-save').on('click', function() {
        ...
        $.ajax({
            url: '{{route("transaksi.olahraga-prestasi.save")}}', // Replace 'your_api_endpoint' with your actual API endpoint
            type: 'POST',
            ...
            success: function(response) {
                ...
                localStorage.removeItem('payloads');
                console.log('Item deleted from localStorage.');
                location.href = "{{route('transaksi.olahraga-prestasi.index')}}";
