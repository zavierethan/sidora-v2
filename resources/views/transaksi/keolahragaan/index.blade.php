    ...
    $(document).ready(function () {
        const table = $("#table").DataTable({
            ...
            columns: [
                ...
                { data: 'nama_desa_kelurahan', name: 'nama_desa_kelurahan' },
                { data: 'jumlah_sarana', name: 'jumlah_sarana', className: 'text-center' },
                { data: 'jumlah_kegiatan_olahraga', name: 'jumlah_kegiatan_olahraga', className: 'text-center' },
                { data: 'jumlah_kegiatan_olahraga', name: 'jumlah_kegiatan_olahraga', className: 'text-center' },
                {
