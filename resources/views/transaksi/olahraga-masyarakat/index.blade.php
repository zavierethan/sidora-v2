                        ...
                        <div id="horizontal-form" class="p-5">
                            <div class="preview">
                                ...
                                <div class="form-inline mt-5">
                                    ...
                                    <select data-placeholder="Pilih Induk Olahraga" class="tom-select w-full form-control" id="organisasi-pembina" name="organisasi_pembina" required disabled>
                                        <option value=" "> - </option>
                                ...
                                <div class="form-inline mt-5">
                                    ...
                                    <select data-placeholder="Pilih Cabang Olahraga" class="tom-select w-full form-control" id="induk-olahraga" name="induk_olahraga" required>
                                        ...
                                        <option value="{{$inorga->id}}">{{$inorga->kategori}} - {{$inorga->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-inline mt-5">
        ...
        $(document).ready(function () {
            const table = $("#table").DataTable({
                ...
                columns: [
                    ...
                    { data: 'nama_induk_olahraga', name: 'nama_cabang_olahraga'},
                    {
                        data: null,
                        name: 'action',
                        orderable: false,
