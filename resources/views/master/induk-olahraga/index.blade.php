        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{route('master.induk-olahraga.save')}}" method="POST" class="intro-y box">
                        @csrf
                        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                            <h2 class="font-medium text-base mr-auto">
                                Form Input Induk Olahraga
                            </h2>
                        </div>
                        <div id="horizontal-form" class="p-5">
                            <div class="preview">
                                <div class="form-inline">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Nama</label>
                                ...
                                <div class="form-inline mt-5">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Organisasi Pembina</label>
...
<script>
    $(document).ready(function () {
        const table = $("#table").DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: `/master/induk-olahraga/get-lists`,
                type: 'GET',
                data: function (d) {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="flex justify-center items-center">
                                <a class="flex items-center text-primary whitespace-nowrap mr-5" href="/master/induk-olahraga/edit/${row.id}"> <i
