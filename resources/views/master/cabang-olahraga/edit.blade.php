...
<div class="content content--top-nav">
    ...
    <div class="intro-y box col-span-12 lg:col-span-6 mt-5">
        <div id="vertical-form" class="p-5">
            <form class="preview" action="{{route('master.cabang-olahraga.update')}}" method="POST"
                ...
                <div class="mt-3 text-right">
                    <a href="{{route('master.cabang-olahraga.index')}}" class="btn btn-danger mt-5">Kembali</a>
