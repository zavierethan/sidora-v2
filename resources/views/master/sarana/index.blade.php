        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="{{route('master.sarana.save')}}" method="POST" class="intro-y box">
                        @csrf
                        ...
                        <div id="horizontal-form" class="p-5">
                            <div class="preview">
                                <div class="form-inline">
                                    <label for="input-wizard-2" class="sm:w-40 font-bold">Nama Sarana</label>
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="flex justify-center items-center">
                                <a class="flex items-center text-primary whitespace-nowrap mr-5" href="/master/sarana/edit/${row.id}"> <i
